...
data2007$Global_reactive_power <- as.numeric(data2007$Global_reactive_power)
data2007$Voltage <- as.numeric(data2007$Voltage)
...
plot(data2007$Time, data2007$Voltage, 
...
plot(data2007$Time, data2007$Global_reactive_power, 
